...
class Servicos{
    ...
    public:
        ...
        void CadastrarJogo(std::string cod_jg, std::string Nome, std::string estadio, std::string cidade, std::string estado,int tipo, Partida part[], int n);
        ...
        void MostrarJogo(std::string cod_jg);
